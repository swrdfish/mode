...
test('Send correct add message signal', () => {
    let uid = '20001'
    let msgType = 'text'
    let body = 'hello'
    let isMine = false
...
test('Send correct delete message signal', () => {
  let id = 20001
  let result = {
    type: 'DEL_MSG',
    id
...
test('Send correct setContactFilter signal', () => {
    let username = 'timon'
    let result = {
...
test('Send correct addUser signal', () => {
  let userData = {
    uuid: 2051,
    name: "timon"
  }
...
test('Send correct removeUser signal', () => {
  let userData = {
    uuid: 2051,
    name: "timon"
  }
...
test('Send correct changeUser signal', () => {
  let userData = {
    uuid: 2051,
    name: "timon"
  }
...
test('Send correct login signal', () => {
  let ref = {some: 'value'}
  let username = 'timon'
  let uid = 2211
...
test('Send correct notify signal', () => {
  let type = 'error'
...
test('Send correct unnotify signal', () => {
  let index = 5
  let result = {
...
test('Send correct joinRoom signal', () => {
...
test('Send correct setUsername signal', () => {
  let username = 'timon'
  let result = {
    type: 'SET_USERNAME',
    username
...
test('Send correct addFiles signal', () => {
  let id = 2048
